...
<div class="col-lg-12">
       ...
       $query2=mysqli_query($con," SELECT * FROM bid_product bp join tablename  tn on tn.id=bp.id  where status='pending' ");
    ...
    echo "<tbody>
		...
		<td><a href='approve.php?approve=$email' class='btn btn-success'>Approve</a></td>
