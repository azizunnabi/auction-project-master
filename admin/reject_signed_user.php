   ...
   <div class="row upload-img">
       ...
       <div class="panel panel-default panel-success text-center">
        <div class="panel-heading">
          <h4 style="color:green">Do You Really Want to Delete This User </h4>
...
include("connect.php");
  ...
  $rej=$_GET['reje'];
        $query=mysqli_query($con,"select * from user_signup where email='$rej'");
...
include("connect.php");
  ...
  if($querry){
    ...
    echo '<script>window.open("signed_users.php","_self")</script>';


    
  }
  else{
    echo '<p style="color:red">Some Thing Went Wrong , user  Account is Not Deleted</p>';
  }
...
if(isset($_POST['no'])){
    ...
    echo '<script>alert("Wellcome Back, You Do Not Want To Delete This User! ")</script>';
